...
# Authors: Yutao Hu*, Qixiong Wang2, Wenqi Shao, Enze Xie, Zhenguo Li, Jungong Han, Ping Luo
# --------------------------------------------------------
...
class REFZOM_REFER:
    def __init__(self, data_root, dataset="refzom"):
        ...
        if dataset == "refzom":
            self.IMAGE_DIR = "path_to/trainval2014"
        else:
        ...
        tic = time.time()
        ref_file = osp.join(self.DATA_DIR, "Ref_ZOM.p")
        self.data = {}
