...
from mllmseg_internvl.dataset_vg import ValVisDataset
...
def evaluate(args, dataset_name, base_image_dir, vis_dir):
    ...
    dataset = ValVisDataset(base_image_dir=base_image_dir, tokenizer=tokenizer, val_dataset=dataset_name, image_size=448)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vis_dir", type=str, default="visualization_results/vlvcl")
